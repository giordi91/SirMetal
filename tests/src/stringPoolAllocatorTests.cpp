...
TEST_CASE("String pool basic alloc 1 static", "[memory]") {
  SirMetal::StringPool alloc(2 << 16);
...
TEST_CASE("String pool basic concatenation 1", "[memory]") {
  ...
  const char *res4 = alloc.concatenatePersistent(
      mem1, mem2, joiner1,
      SirMetal::STRING_MANIPULATION_FLAGS::FREE_FIRST_AFTER_OPERATION);
  ...
  const char *res5 = alloc.concatenatePersistent(
      mem1, mem2, joiner1,
      SirMetal::STRING_MANIPULATION_FLAGS::FREE_FIRST_AFTER_OPERATION |
          SirMetal::STRING_MANIPULATION_FLAGS::FREE_SECOND_AFTER_OPERATION);
  ...
  const char *res6 = alloc.concatenatePersistent(
      ...
      SirMetal::STRING_MANIPULATION_FLAGS::FREE_FIRST_AFTER_OPERATION |
          SirMetal::STRING_MANIPULATION_FLAGS::FREE_SECOND_AFTER_OPERATION |
          SirMetal::STRING_MANIPULATION_FLAGS::FREE_JOINER_AFTER_OPERATION);
