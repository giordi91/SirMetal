...
TEST_CASE("Random size allocator simple allocation", "[memory]") {
  ...
  SirMetal::RandomSizeAllocator alloc;
  alloc.initialize(256);
  SirMetal::RandomSizeAllocationHandle mem = alloc.allocate(16);
...
TEST_CASE("Random size allocator multiple allocations", "[memory]") {
  ...
  SirMetal::RandomSizeAllocator alloc;
  alloc.initialize(256);
  SirMetal::RandomSizeAllocationHandle mem1 = alloc.allocate(16);
  memset(alloc.getPointer(mem1), 0, mem1.dataSize);
  REQUIRE(alloc.getFreeBlocksCount() == 0);
  SirMetal::RandomSizeAllocationHandle mem2 = alloc.allocate(24);
  memset(alloc.getPointer(mem2), 0, mem2.dataSize);
  REQUIRE(alloc.getFreeBlocksCount() == 0);
  SirMetal::RandomSizeAllocationHandle mem3 = alloc.allocate(48);
  memset(alloc.getPointer(mem3), 0, mem3.dataSize);
  REQUIRE(alloc.getFreeBlocksCount() == 0);
  SirMetal::RandomSizeAllocationHandle mem4 = alloc.allocate(8);
  memset(alloc.getPointer(mem4), 0, mem4.dataSize);
  REQUIRE(alloc.getFreeBlocksCount() == 0);
  SirMetal::RandomSizeAllocationHandle mem5 = alloc.allocate(16);
  ...
  // memory wise
  SirMetal::RandomSizeAllocationHandle newMem2 = alloc.allocate(12);
  ...
  SirMetal::RandomSizeAllocationHandle newMem3 = alloc.allocate(18);
  ...
  SirMetal::RandomSizeAllocationHandle newMem5 = alloc.allocate(16);
  ...
  SirMetal::RandomSizeAllocationHandle newMem4 = alloc.allocate(12);
